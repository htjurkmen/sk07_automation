...
public class PostsTest extends BaseTest {
    ...
    public Object[][] getData() {
        return new Object[][]{
                {"auto_user", "auto_pass", new File("src/test/java/lecture17/examples/upload/pretty.jpg"), "caption"}
        };
    }
    ...
    public void testCreatePost(String username, String password, File file, String captionText) {
        ...
        Assert.assertEquals(postModal.getPostUsername(), username, "Username is not correct in the post!");
    }
